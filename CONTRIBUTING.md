...
- Do not add new agents. The system has exactly 19. I have thought about this extensively.
- Do not add new modules. Echo, Agents, Forge, Vault, Codex, Athena. That is the complete set. No seventh module.
- Do not break the SDD workflow. Atlas asks questions on complex tasks by design — do not remove this behavior.
